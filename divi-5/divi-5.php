...
add_action( 'divi_visual_builder_assets_before_enqueue_packages', 'dtmc_divi5_enqueue_visual_builder_assets' ); // You must use this hook to enqueue your assets for the Divi 5 Visual Builder.